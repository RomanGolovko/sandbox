...
namespace ExplosionDanger.WinForm
{
    public partial class ΔРWith : Form
    {
        ...
        private void btn_calculate_Click(object sender, EventArgs e)
        {
            ...
            calculation.Fиж = (txbx_Fuж.Text.Trim() != "") ? double.Parse(txbx_Fuж.Text.Trim()) : 0;
            calculation.Fиемк = (txbx_Fuемк.Text.Trim() != "") ? double.Parse(txbx_Fuемк.Text.Trim()) : 0;
            calculation.Fисв = (txbx_Fuсв.Text.Trim() != "") ? double.Parse(txbx_Fuсв.Text.Trim()) : 0;
            calculation.τиспж = (txbx_τиспж.Text.Trim() != "") ? double.Parse(txbx_τиспж.Text.Trim()) : 0;
            calculation.τиспемк = (txbx_τиспемк.Text.Trim() != "") ? double.Parse(txbx_τиспемк.Text.Trim()) : 0;
            calculation.τиспсв = (txbx_τиспсв.Text.Trim() != "") ? double.Parse(txbx_τиспсв.Text.Trim()) : 0;
